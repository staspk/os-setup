...
- PowershellConfigurer. 
	...
	- PowershellProfile Derived Classes have hard-coded $profile $paths set to [Microsoft Standard Spec](https://learn.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_profiles?view=powershell-5.1). However, with new Versions of Win10/11 Home, OneDrive will default to setting the global automatic variable $profile values [to what Microsoft Specifically Advises to Avoid: `C:\Users\{username}\OneDrive\Documents\...`](https://learn.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_profiles?view=powershell-7.4), as opposed to the older, correct, classic path at: `C:\Users\{username}\Documents\...`.
