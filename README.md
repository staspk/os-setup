[![OS-Setup:Collection of scripts/files to setup/debloat/configure a clean OS Install.](https://github.com/staspk/OS-Setup/blob/main/assets/Os_Setup.png)]([link-url](https://github.com/staspk/OS-Setup))
